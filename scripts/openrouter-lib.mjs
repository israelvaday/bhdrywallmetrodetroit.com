/**
 * Shared OpenRouter client for BH Drywall Metro Detroit site generation.
 */
...
const SITE = "https://bhdrywallmetrodetroit.com";
const APP_TITLE = "BH Drywall Metro Detroit";
